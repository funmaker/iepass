...
__lua__
p8rs.test_mem("Draw state - initial", 0x5f00, 0x40)
print("Initial")
p8rs.test_mem("Draw state - basic", 0x5f00, 0x40)
print("Offset", 10, 20)
p8rs.test_mem("Draw state - offsets", 0x5f00, 0x40)
print("Continue")
print("With\n  newline")
p8rs.test_mem("Draw state - after newline", 0x5f00, 0x40)
print("aFTER nEWLINE")
p8rs.test_scr("Basic")
...
p8rs.test_mem("Draw state - horizonal clips", 0x5f00, 0x40)
print("Clip top - off-screen", 40, -22)
p8rs.test_mem("Draw state - clipped off top", 0x5f00, 0x40)
print("Clip top", 40, -3)
p8rs.test_mem("Draw state - clipped partial", 0x5f00, 0x40)
